<template>
    <div>
        <h3>Administracion de Meseros</h3>
        <Toolbar class="mb-4">
            <template v-slot:start>
                <div class="my-2">
                    <Button label="Añadir nuevo Mesero" icon="pi pi-plus" class="p-button-success mr-2"
        ...
        <DataTable :value="CRUD_MESEROS.tablaMeseros" v-model:selection="meseroItem"
            class="p-datatable-gridlines" dataKey="id_mesero" :rows="5"
            ...
            <Column field="id_mesero" header="ID" style="width:10px"></Column>
            <Column field="nombre_mesero" header="Nombre" style="width:140px"></Column>
            ...
            <Column style="width:20px">
                ...
                <template #body="slotProps">
                    <Button icon="pi pi-pencil" type="button" class="p-button-raised p-button-success mr-2 mb-2"
                        @click="(slotProps.data.id_mesero)"></Button>
                    <Button icon="pi pi-trash" type="button" class="p-button-raised p-button-danger mr-2 mb-2"
                        @click="confirmaEliminarProductos(slotProps.data.id_mesero)"></Button>
                </template>
            </Column>
        </DataTable>
    </div>
...
export default {
    data() {
        return {
            ...
            CRUD_MESEROS: {
                tablaMeseros: [{
                    'id_mesero': 1, 'nombre_mesero': 'Juan Perez', 'sueldo': 800
                },
                {
                    'id_mesero': 2, 'nombre_mesero': 'Ramon Morales', 'sueldo': 700
                }],
